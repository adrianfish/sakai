...
public class TagsConfiguration implements WebApplicationInitializer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        rootContext.register(TagsWebMvcConfiguration.class);
        ...
        ServletRegistration.Dynamic servlet = servletContext.addServlet("sakai.tagservice", new DispatcherServlet(rootContext));
        servlet.addMapping("/");
