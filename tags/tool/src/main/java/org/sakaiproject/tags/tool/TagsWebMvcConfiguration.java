...
@Configuration
@EnableWebMvc
@ComponentScan("org.sakaiproject.tags.tool")
public class TagsWebMvcConfiguration implements ApplicationContextAware, WebMvcConfigurer {
    ...
    public MessageSource messageSource() {
        ...
        messages.setBasename("tagservice");
        return messages;
    }
