    ...
    caches
      ...
      .then(cache =>
        cache.addAll([
          ...
          "/library/skin/default-skin/fonts/bootstrap-icons.woff2?8d200481aa7f02a2d63a331fc782cfaf",
    ...
    (async () => {
      ...
      if (navigator.onLine) {
        ...
        return fetch(event.request).then(fetchedResponse => {
          ...
          if (event.request.method === "GET" && (event.request.url.match(/direct\/portal\/notifications\.json/)
