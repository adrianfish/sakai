...
import org.sakaiproject.meetings.api.storage.MeetingParticipant;
...
public class MeetingsServiceImpl implements MeetingsService {
    ...
    @Resource private MeetingsStorageManager storageManager;
    ...
    public List<Meeting> getSiteMeetings(String siteId) throws SecurityException, Exception {
        ...
        List<Meeting> meetings = storageManager.getSiteMeetings(siteId, NOT_INCLUDE_DELETED_MEETINGS);
    ...
    public boolean createMeeting(Meeting meeting, boolean notifyParticipants, boolean addToCalendar, boolean iCalAttached, Long iCalAlarmMinutes)
    ...
    public boolean updateMeeting(Meeting meeting, boolean notifyParticipants, boolean addToCalendar, boolean iCalAttached, Long iCalAlarmMinutes, boolean meetingOnly)
            throws SecurityException, MeetingsException {
    ...
    public Map<String, Object> getMeetingInfo(String meetingID, String groupId) throws MeetingsException {

        log.debug("getMeetingInfo({}, {})", meetingID, groupId);

        Meeting meeting = storageManager.getMeeting(meetingID);
    ...
    public Map<String, Object> getSiteRecordings(String siteId) throws SecurityException, Exception {
        ...
        List<Meeting> meetings = storageManager.getSiteMeetings(siteId, INCLUDE_DELETED_MEETINGS);
    ...
    public boolean databaseStoreMeeting(Meeting meeting) {
    ...
    public String getJoinUrl(Meeting meeting, User user)
            throws SecurityException, Exception {
    ...
    // --- BBB Private methods -----------------------------------------------
    // -----------------------------------------------------------------------
    private Meeting processMeeting(Meeting meeting)
            throws SecurityException, Exception {
        if (meeting == null) return null;
