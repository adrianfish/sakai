...
public class MeetingsEntityProvider extends AbstractEntityProvider implements
    ...
    public Object getEntity(EntityReference ref) {
        ...
        try {
            Meeting meeting = meetingManager.getMeeting(id);
    ...
    public void updateEntity(EntityReference ref, Object entity, Map<String, Object> params) {
        ...
        try {
            Meeting meeting = meetingManager.getMeeting(ref.getId());
            if (meeting == null) {
    ...
    public List<Meeting> getEntities(EntityReference ref, Search search) {
    ...
    public String joinMeeting(OutputStream out, EntityView view, EntityReference ref, Map<String, Object> params) {
        ...
        try {
            ...
            if( waitmoderatorEnabled && meeting.getWaitForModerator() ){
                MeetingParticipant p = meetingManager.getParticipantFromMeeting(meeting, userDirectoryService.getCurrentUser().getId());
    ...
    private String getHtmlForJoining(String joinUrl, String meetingId, boolean waitformoderator, String groupId){
        ...
        String waiting_for_moderator_tooltip = toolMessages.getString("meetings_meetinginfo_waiting_for_moderator_tooltip");
        ...
        if( waitformoderator ){
            return commonHtmlHeader +
                   ...
                   "            jQuery.ajax( {\n" +
                   "                url: '/direct/meetings/" + meetingId + "/getMeetingInfo.json" + (groupId.equals("") ? "" : "?groupId=" + groupId) + "',\n" +
                   "                dataType : 'json',\n" +
                   "                async : false,\n" +
                   "                cache: false,\n" +
                   ...
                   "      <img id='joining' src='/meetings-tool/images/2.gif' title='" + waiting_for_moderator_tooltip + "' alt='" + waiting_for_moderator_tooltip + "' />\n" +
                   "    </div>\n" +
                   "  </body>\n" +
                   commonHtmlFooter;
        } else {
