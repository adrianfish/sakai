...
(function ($) {
    ...
    meetings.utils.getMeeting = function (meetingId) {
        ...
        var meeting = null;
        $.ajax({
            url: "/direct/meetings/" + meetingId + ".json",
            dataType: "json",
            async: false,
    ...
    meetings.utils.setMeetingInfo = function (meeting, asyncmode, groupId) {
        ...
        jQuery.ajax({
            url: "/direct/meetings/" + meeting.id + "/getMeetingInfo.json" + groupID,
            dataType: "json",
            async: asyncmode,
            timeout: 10000,
            success: function (data) {},
    ...
    meetings.utils.getGroups = function (meeting) {
        var groups;
        jQuery.ajax({
            url: "/direct/meetings/getGroups.json?meetingID=" + meeting.id,
            dataType: "json",
            async: false,
            timeout: 10000,
            success: function (data) {
    ...
    meetings.utils.addNotice = function () {
        ...
        jQuery.ajax({
            url: "/direct/meetings/getNoticeText.json",
            dataType: "json",
            async: true,
