...
public interface MeetingsService {
     ...
     */
    Meeting getMeeting(String meetingId) throws SecurityException, Exception;
     ...
     */
    List<Meeting> getSiteMeetings(String siteId) throws SecurityException, Exception;
     ...
     * @param meeting
     */
    boolean createMeeting(Meeting meeting, boolean notifyParticipants, boolean addToCalendar, boolean iCalAttached, Long iCalAlarmMinutes)
     ...
     * @param meeting
     */
    boolean updateMeeting(Meeting meeting, boolean notifyParticipants, boolean addToCalendar, boolean iCalAttached, Long iCalAlarmMinutes, boolean meetingOnly)
            throws SecurityException, MeetingsException;
     ...
     */
    Map<String, Object> getMeetingInfo(String meetingID, String groupId) throws MeetingsException;

    /**
     * Get playback recordings from Meetings server.
     */
    Map<String, Object> getRecordings(String meetingID, String groupId, String siteId) throws MeetingsException;
     ...
     */
    boolean deleteMeeting(String id) throws SecurityException, MeetingsException;

    /**
     * Only executes endMeeting.
     */
    boolean endMeeting(String id, String groupId, boolean endAll) throws SecurityException, MeetingsException;
    ...
    boolean databaseStoreMeeting(Meeting meeting);
