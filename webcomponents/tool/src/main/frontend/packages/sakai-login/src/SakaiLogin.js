...
export class SakaiLogin extends SakaiElement {
  ...
  constructor() {
    ...
    //this.loadTranslations("sakai-login").then(r => this._i18n = r);
  }
  ...
  _login() {
    ...
    .then(userId => {
      ...
      console.debug(`Logged in at ${url}. UserId: ${userId}`);
      this.dispatchEvent(new CustomEvent("login-successful", { detail: { userId } }));
    })
