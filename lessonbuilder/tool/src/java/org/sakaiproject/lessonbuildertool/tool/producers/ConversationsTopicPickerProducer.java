...
public class ConversationsTopicPickerProducer implements ViewComponentProducer, NavigationCaseReporter, ViewParamsReporter {
    ...
    private LessonEntity topicEntity = null;
    ...
    public void fillComponents(UIContainer tofill, ViewParameters viewparams, ComponentChecker checker) {
        ...
        if (((GeneralViewParameters) viewparams).getSendingPage() != -1) {
            ...
            try {
                ...
                log.info("Execption while updating page object: {}", e.toString());
                return;
            }
        }
        ...
        if (simplePageBean.canEditPage()) {
            ...
            /*
            List<UrlItem> createLinks = topicEntity.createNewUrls(simplePageBean);
            int toolNum = 0;
            for (UrlItem createLink: createLinks) {
                UIBranchContainer link = UIBranchContainer.make(tofill, "conversations-topic-create:");
            ...
            */
            ...
            List<LessonEntity> topics = topicEntity.getEntitiesInSite();
            //List<LessonEntity> topics = new ArrayList<>();

            UIForm form = UIForm.make(tofill, "conversations-topic-picker");
            ...
            */
            ...
            UISelect select = UISelect.make(form, "topic-span", values.toArray(new String[1]), "#{simplePageBean.selectedEntity}", currentItem);
            for (LessonEntity topic : topics) {

                UIBranchContainer row = UIBranchContainer.make(form, "topic:", String.valueOf(topics.indexOf(topic)));
                ...
                if (topic.isUsable()) {
                    ...
                    String titleTemplate = messageLocator.getMessage("simplepage.cc-defaulttopic");
    ...
    public List reportNavigationCases() {
        ...
        return List.<NavigationCase>of(
            new NavigationCase("success", new SimpleViewParameters(ShowPageProducer.VIEW_ID)),
            new NavigationCase("failure", new SimpleViewParameters(ConversationsTopicPickerProducer.VIEW_ID)),
            new NavigationCase("cancel", new SimpleViewParameters(ShowPageProducer.VIEW_ID)));
    }
}
