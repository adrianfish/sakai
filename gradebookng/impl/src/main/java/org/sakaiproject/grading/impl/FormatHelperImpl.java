...
public class FormatHelperImpl {
     ...
     */
    public String formatDoubleToDecimal(final Double score) {
        if (score == null) {
                        return "";
        }
        else {
     ...
     */
    private String formatDoubleToDecimal(final Double score, final int n) {
        return formatGrade(convertDoubleToBigDecimal(score, n).toString());
    }

    private BigDecimal convertDoubleToBigDecimal(final Double score, final int decimalPlaces) {
    ...
    private BigDecimal convertStringToBigDecimal(final String score, final int decimalPlaces) {
        return new BigDecimal(score)
                .setScale(10, RoundingMode.HALF_UP)
                .setScale(decimalPlaces, RoundingMode.HALF_UP);
    }
     ...
     * @return double to decimal places
     */
    public String formatDoubleToMatch(final Double score, final String toMatch) {
        ...
        return formatDoubleToDecimal(score, numberOfDecimalPlaces);
    }
     ...
     */
    public String formatDoubleAsPercentage(final Double score) {
     ...
     * @return percentage to decimal places with a '%' for good measure
     */
    public String formatStringAsPercentage(final String string) {
     ...
     * @return
     */
    public String formatGrade(final String grade) {
     ...
     */
    public String formatGradeFromUserLocale(final String grade) {
     ...
     * @return
     */
    public String formatGradeForDisplay(final Double grade) {
     ...
     * @return
     */
    public String formatGradeForDisplay(final String grade) {
     ...
     */
    public String convertEmptyGradeToDash(final String grade) {
     ...
     * @return
     */
    public String formatGradeForLocale(final String grade, final Locale locale) {
        if (StringUtils.isBlank(grade)) {
            return "";
        }
     ...
     * @return
     */
    public String formatDate(final Date date, final String ifNull) {
        if (date == null) {
            return ifNull;
        }
     ...
     */
    public String stripLineBreaks(final String s) {
        return s.replaceAll("\\r\\n|\\r|\\n", "");
    }
     ...
     */
    public String abbreviateMiddle(final String s) {
     ...
     */
    public Double validateDouble(final String value) {
     ...
     */
    public List<String> formatCategoryDropInfo(CategoryDefinition category) {
    ...
    * Reference: http://www.w3.org/TR/html4/sgml/entities.html
     ...
     */
    public String getGradeFromNumber(String newGrade, Map<String, Double> schema, Locale currentUserLocale) {
     ...
     * @return the grade
     */
    public String getNumberFromGrade(String gradeScale, Map<String, Double> schema, Locale currentUserLocale) {
     ...
     */
    public String transformNewGrade(String newGrade, Locale locale) {
        try {
