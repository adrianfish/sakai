...
public class AnalyticsConfiguration implements WebApplicationInitializer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        rootContext.register(AnalyticsWebMvcConfiguration.class);
        ...
        ServletRegistration.Dynamic servlet = servletContext.addServlet("sakai.analytics", new DispatcherServlet(rootContext));
        servlet.addMapping("/");
