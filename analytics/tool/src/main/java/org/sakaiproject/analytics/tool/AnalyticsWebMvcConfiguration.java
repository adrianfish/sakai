...
@Configuration
@EnableWebMvc
@ComponentScan("org.sakaiproject.analytics")
public class AnalyticsWebMvcConfiguration implements ApplicationContextAware, WebMvcConfigurer {
    ...
    public MessageSource messageSource() {
        ...
        messageSource.setBasename("analytics");
