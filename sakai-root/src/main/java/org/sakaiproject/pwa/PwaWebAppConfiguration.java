...
public class PwaWebAppConfiguration implements WebApplicationInitializer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        rootContext.register(PwaWebMvcConfiguration.class);
        ...
        ServletRegistration.Dynamic servlet = servletContext.addServlet("sakai.pwa", new DispatcherServlet(rootContext));
        servlet.addMapping("/");
